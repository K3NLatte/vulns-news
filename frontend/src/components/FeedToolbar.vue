...
<template>
  <div class="feed-toolbar">
    <div class="search-field">
      ...
      <input
        id="feed-search" type="search" :value="search" placeholder="製品名・キーワードで検索"
        @input="emit('update:search', ($event.target as HTMLInputElement).value)"
      />
      <button v-if="search" type="button" class="icon-button clear-search" aria-label="検索をクリア" @click="emit('update:search', '')">
